...
import io.github.codex_agent_labs.codexagent.capi.headers.codex_agent_conversation_open_options
import io.github.codex_agent_labs.codexagent.capi.headers.codex_agent_host_options
...
public fun codexAgentHostStateRequirementReason(
    ...
    withPayload<CodexAgentCHostStateSnapshot>(
        ...
        outReason.pointed.value = when (required.requirement.reason) {
            io.github.codex_agent_labs.codexagent.agent.CodexWorkspaceSelectionReason.NOT_SELECTED -> 0
            io.github.codex_agent_labs.codexagent.agent.CodexWorkspaceSelectionReason.NOT_FOUND -> 1
            io.github.codex_agent_labs.codexagent.agent.CodexWorkspaceSelectionReason.ACCESS_REVOKED -> 2
            io.github.codex_agent_labs.codexagent.agent.CodexWorkspaceSelectionReason.INVALID_SELECTION -> 3
        }
        CODEX_AGENT_STATUS_OK
    }
}
...
private fun copyHostWorkspace(
    ...
    capacity: ULong,
    outRequired: CPointer<ULongVar>?,
    select: (io.github.codex_agent_labs.codexagent.agent.CodexWorkspace) -> String,
): Int = abiStatus {
    withPayload<CodexAgentCHostStateSnapshot>(
        context,
        snapshot,
