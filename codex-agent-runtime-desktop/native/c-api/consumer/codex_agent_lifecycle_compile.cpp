...
static_assert(CODEX_AGENT_ABI_VERSION_MINOR == UINT32_C(4));
static_assert(CODEX_AGENT_ABI_VERSION_PATCH == UINT32_C(0));
static_assert(CODEX_AGENT_ABI_VERSION_CURRENT == UINT32_C(0x01040000));
static_assert(CODEX_AGENT_ABI_VERSION_MINIMUM_COMPATIBLE == UINT32_C(0x01000000));
static_assert(CODEX_AGENT_ABI_VERSION_ENCODE(1, 4, 0) == CODEX_AGENT_ABI_VERSION_CURRENT);
