...
static_assert(CODEX_AGENT_ABI_VERSION_MINOR == UINT32_C(12));
static_assert(CODEX_AGENT_ABI_VERSION_PATCH == UINT32_C(0));
static_assert(CODEX_AGENT_ABI_VERSION_CURRENT == UINT32_C(0x010C0000));
static_assert(CODEX_AGENT_ABI_VERSION_MINIMUM_COMPATIBLE == UINT32_C(0x01000000));
static_assert(CODEX_AGENT_ABI_VERSION_ENCODE(1, 12, 0) == CODEX_AGENT_ABI_VERSION_CURRENT);
