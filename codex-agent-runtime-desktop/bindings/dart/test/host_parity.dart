...
Future<void> verifyRealHostBoundary(
  ...
  if (!library.existsSync()) {
    throw StateError('real SDK is required; set CODEX_AGENT_REAL_LIBRARY');
  }
...
void registerHostParity(
  ...
  test('dart.host inventory and production edges fail closed', () {
    ...
    final client =
        File('${root.path}/codex-agent-runtime-desktop/bindings/dart/'
                'lib/src/client.dart')
            .readAsStringSync();
    final ffi = File('${root.path}/codex-agent-runtime-desktop/bindings/dart/'
            'lib/src/ffi.dart')
        .readAsStringSync();
