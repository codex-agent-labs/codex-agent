...
`0.2.0` is published, install a locally built matching wheel. The package
...
[lifecycle consumer example](https://github.com/codex-agent-labs/codex-agent/blob/main/codex-agent-runtime-desktop/bindings/python/consumer/lifecycle_example.py).
