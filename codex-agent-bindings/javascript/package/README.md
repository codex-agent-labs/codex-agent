...
The ESM/CommonJS package coordinate is
`@codex-agent-labs/codex-agent@<sdkVersion>`; use the locally assembled package
...
compatible Desktop Runtime identity:

```text
codex-agent-runtime-desktop-<runtimeCompatibilityVersion>-app-server-<host>-<architecture>.zip
```
